...
(function(){
    ...
    function displayData(data)
                                        ...
                                        <td class="column-1">
                                            ...
                                            <td class="column-4">
                                                <div class="flex-w bo5 of-hidden w-size17">
                                                    ...
                                                    <input id="itemNumber" class="size8 m-text18 t-center num-product" type="number" name="num-product1" value="1">
        ...
        function calcTotal(){
            ...
            document.getElementById("totalCart").innerHTML = totalOfItems.toFixed(2);
        }
